...
echo "Setup of projects index and mapping:"
curl -XPUT "localhost:9200/projects" -d @/tmp/setup.json

echo "Import of data into Elasticsearch:"
curl -XPOST "localhost:9200/_bulk" --data-binary @data/data.json
